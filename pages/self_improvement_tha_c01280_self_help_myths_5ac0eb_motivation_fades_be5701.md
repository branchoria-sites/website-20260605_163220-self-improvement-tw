...
show_ads: true
description: Motivational highs can help people start, but lasting change usually depends on plans, cues and routines that survive ordinary stress.
hero_summary: Motivational highs can help people start, but lasting change usually depends on plans, cues and routines that survive ordinary stress.
layout: default
...
page_heading_title: Why Motivation Fades by Tuesday Afternoon
source_count: 47
infographic_count: 3
planned_sections:
...
image: /assets/images/self_improvement_tha_c01280_self_help_myths_5ac0eb_motivation_fades_be5701-Illustration-1-social.jpg
---
...
* [Social pressure]({{ 'social-pressure/' | relative_url }}) supports action.
...
* Existing habits reappear. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.washingtonpost.com/wellness/2026/04/26/habit-stacking/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: washingtonpost.com">[washingtonpost.com]</a><span class="citation-popover" role="note"><span class="citation-popover-source">washingtonpost.com</span><span class="citation-popover-snippet">Popularized by authors BJ Fogg and James Clear, and widely used by behavioral therapists, habit-stacking involves &quot;stacking&quot; small, speci...</span></span></span>
* Stress consumes attention.
* The [environment]({{ 'environment/' | relative_url }}) remains largely unchanged.
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Why Motivation Fades by Tuesday Afternoon. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses why systems outperform temporary motivation.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains behaviour design beyond motivation spikes.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=The+Motivation+Myth+by+Jeff+Haden&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open The Motivation Myth on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://books.google.com/books/content?id=GA2jDgAAQBAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=1&amp;edge=curl&amp;source=gbs_api" alt="Cover for The Motivation Myth" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=The+Motivation+Myth+by+Jeff+Haden&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="The Motivation Myth">The Motivation Myth</a>
        </h4>
        <p class="fr-book-author">By Jeff Haden</p>
        
        <p class="fr-book-desc">Argues that action creates motivation rather than the reverse.</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=The+Motivation+Myth+by+Jeff+Haden&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
