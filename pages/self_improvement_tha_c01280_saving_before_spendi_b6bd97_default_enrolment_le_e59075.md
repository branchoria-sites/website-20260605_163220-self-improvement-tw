...
show_ads: true
description: Pension defaults show why opt-out systems can raise saving, while also warning that default amounts may be too low.
hero_summary: Pension defaults show why opt-out systems can raise saving, while also warning that default amounts may be too low.
layout: default
...
page_heading_title: What pension defaults teach everyday savers
source_count: 61
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why payday is the best time to save
header:
  og_image: /assets/images/self_improvement_tha_c01280_saving_before_spendi_b6bd97_default_enrolment_le_e59075-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_saving_before_spendi_b6bd97_default_enrolment_le_e59075-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_saving_before_spendi_b6bd97_default_enrolment_le_e59075-Illustration-1-social.jpg
---
...
## What everyday savers can borrow from automatic enrolment

The success of automatic enrolment suggests several practical rules for saving before spending.

First, make saving the default. Arrange transfers to occur automatically on payday or immediately after income arrives. This recreates the core mechanism that made pension enrolment successful.

Second, make opting out slightly inconvenient. A savings system is stronger when stopping it requires a conscious decision rather than passive neglect. The goal is not to trap yourself but to prevent routine spending from quietly displacing long-term goals.
