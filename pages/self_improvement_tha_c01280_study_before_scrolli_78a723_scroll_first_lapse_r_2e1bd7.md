...
show_ads: true
description: A good recovery rule stops one accidental scroll from turning into a lost evening.
hero_summary: A good recovery rule stops one accidental scroll from turning into a lost evening.
layout: default
...
page_heading_title: How to Recover After Scrolling First
source_count: 65
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When Should Scrolling Become the Reward?
header:
  og_image: /assets/images/self_improvement_tha_c01280_study_before_scrolli_78a723_scroll_first_lapse_r_2e1bd7-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_study_before_scrolli_78a723_scroll_first_lapse_r_2e1bd7-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_study_before_scrolli_78a723_scroll_first_lapse_r_2e1bd7-Illustration-1-social.jpg
---
...
> “The lapse happened. The session is still recoverable. Start the next study step.”
...
1. **Close the feed.**
2. **Move the phone away from the study area.**
3. **Open the study material immediately.**
4. **Complete one tiny task that takes less than two minutes.**
...
* Writing the date at the top of a page.
* Reading one paragraph.
* Solving the first line of a problem.
* Reviewing three flashcards.
* Opening the assignment document and writing one sentence.
...
* **If** I catch myself scrolling before I begin, **then** I will put the phone across the room and read one page.
* **If** I spend more than ten minutes on social media, **then** I will start a five-minute study timer immediately.
* **If** I open a feed while preparing to study, **then** I will close it and complete the first question in my notes.
...
The biggest danger after a scroll-first lapse is not the scrolling itself. It is the interpretation.

Students frequently fall into one of three traps:

**The sunk-cost trap.**

“I already wasted twenty minutes, so today is ruined.”

**The perfection trap.**

“If I cannot follow the plan exactly, there is no point continuing.”
...
> “How quickly did I return to studying after I noticed?”
...
* Was the phone already in your hand when the study session began?
* Did a notification trigger the check?
* Was the first study task unclear?
* Were you trying to start with a task that felt too large?
* Were you studying in a place strongly associated with entertainment?

</div>

The goal is not a detailed post-mortem. It is one small adjustment.
...
* Turn off non-essential notifications before study time.
* Leave the textbook open on the correct page.
* Define the first task before the session begins.
* Start with five minutes rather than an intimidating block.
