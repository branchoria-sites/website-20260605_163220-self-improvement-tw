...
show_ads: true
description: Where a phone lives can decide whether bedtime becomes scrolling time or recovery time.
hero_summary: Where a phone lives can decide whether bedtime becomes scrolling time or recovery time.
layout: default
...
page_heading_title: Should your phone sleep outside the bedroom?
source_count: 55
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Make bad habits just inconvenient enough
header:
  og_image: /assets/images/self_improvement_tha_c01280_environment_design_133edb_phone_placement_slee_9e8ca6-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_environment_design_133edb_phone_placement_slee_9e8ca6-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_environment_design_133edb_phone_placement_slee_9e8ca6-Illustration-1-social.jpg
---
...
Research on smartphone use in bed has found associations between bedtime phone use and poorer sleep outcomes. A 2022 study analysing smartphone use during sleep periods reported significant adverse effects on sleep latency, awake time and other sleep-related measures. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://pmc.ncbi.nlm.nih.gov/articles/PMC9707689/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: pmc.ncbi.nlm.nih.gov">[PMC]</a><span class="citation-popover" role="note"><span class="citation-popover-source">pmc.ncbi.nlm.nih.gov</span><span class="citation-popover-snippet">study on the effect of mobile phone use on sleep - PMCby S Sinha · 2022 · Cited by 25 — Usage of mobile phone at bedtime, significantly i...</span></span></span>
...
This does not mean every study finds identical effects. Some researchers have reported weaker or more conditional results, especially when smartphone dependency is low. However, the overall pattern suggests that proximity itself can carry an attentional cost. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.sciencedirect.com/science/article/abs/pii/S1053810020301975" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: sciencedirect.com">[ScienceDirect]</a><span class="citation-popover" role="note"><span class="citation-popover-source">sciencedirect.com</span><span class="citation-popover-title">ScienceDirect Does a smartphone on the desk drain our brain?</span><span class="citation-popover-snippet">M Hartmann · 2020 · Cited by 43 — We found no overall effect of smartphone presence on short-term and prospective memory perform...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Should your phone sleep outside the bedroom?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Advocates intentional technology use and environmental boundaries.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses reducing smartphone dependence and changing phone habits.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides strategies for reducing compulsive checking and interruptions.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains how changing cues and accessibility changes behavior.</p>
        <div class="fr-book-actions">
