...
show_ads: true
description: Self-nudging is most credible when the person can see, review and change the defaults shaping their own choices.
hero_summary: Self-nudging is most credible when the person can see, review and change the defaults shaping their own choices.
layout: default
...
page_heading_title: When is a self nudge still free choice?
source_count: 52
infographic_count: 3
planned_sections:
...
image: /assets/images/self_improvement_tha_c01280_choice_architecture_214f66_ethical_self_nudging_d76e0b-Illustration-1-social.jpg
---
...
For this reason, ethical self-nudging requires mechanisms for periodic scrutiny. Otherwise a tool designed to [support]({{ 'support/' | relative_url }}) autonomy can gradually substitute for it.
...
1. What recurring actions happen automatically in my life?
2. Which of them still serve current goals?
3. Which create friction without clear benefit?
4. Which would I choose again today?
5. Which need modification or removal?
