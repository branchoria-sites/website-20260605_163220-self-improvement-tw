...
show_ads: true
description: A slightly longer route with quieter roads, better lighting, or fewer hostile junctions can make commuting more sustainable than the shortest path.
hero_summary: A slightly longer route with quieter roads, better lighting, or fewer hostile junctions can make commuting more sustainable than the shortest path.
layout: default
...
page_heading_title: Why the Shortest Bike Route May Fail
source_count: 40
infographic_count: 3
planned_sections:
- Shortest route versus sustainable route
- Testing junctions, surfaces, lighting, and traffic stress
...
image: /assets/images/self_improvement_tha_c01280_cycling_to_work_894f2f_route_backup_options_c4f093-Illustration-1-social.jpg
---
...
A backup route should be tested before it is needed.

Many commuters discover problems only when circumstances force a change. A route that appears attractive online may conceal a dangerous right turn, poor road surface, confusing cycle infrastructure, or a badly lit path.

Useful route testing focuses on four practical factors:

**Junction stress.** A single difficult junction can create more anxiety than several kilometres of ordinary riding. Test major intersections during the times you will actually commute, not just on a quiet Sunday afternoon.
...
* **Normal route:** the everyday option with the best balance of time and comfort.
* **Bad-weather route:** prioritises predictable surfaces, lighting, and easier junctions.
* **Fast route:** used when genuinely time-pressed, even if it involves slightly more traffic.
...
A backup route is not always another cycling route.
...
* Nearby railway stations that accept bicycles.
* Convenient bus or alternative transport links where local rules permit bike carriage.
* Family or friends who could collect you in an emergency.
* Secure locations where a bike can be left temporarily if continuing becomes impractical.
...
People often frame cycling routes as navigation problems. In reality, they are habit-design problems.

The route that survives darkness, rain, fatigue, roadworks, and occasional mechanical trouble is usually not the shortest one. It is the route that asks the least from you when your [motivation]({{ 'motivation/' | relative_url }}) is low.
