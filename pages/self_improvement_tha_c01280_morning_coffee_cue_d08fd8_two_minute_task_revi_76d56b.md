...
show_ads: true
description: A tiny review can turn coffee time into a clear first action instead of a full planning ritual.
hero_summary: A tiny review can turn coffee time into a clear first action instead of a full planning ritual.
layout: default
...
page_heading_title: The Two Minute Review Before Email
source_count: 15
infographic_count: 3
planned_sections:
...
image: /assets/images/self_improvement_tha_c01280_morning_coffee_cue_d08fd8_two_minute_task_revi_76d56b-Illustration-1-social.jpg
---
...
* Write the [first sentence]({{ 'first-sentence/' | relative_url }}).
* Make the first call.
