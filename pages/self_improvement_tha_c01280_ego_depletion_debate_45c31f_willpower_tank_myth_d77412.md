...
show_ads: true
description: The fuel-tank metaphor feels intuitive, but it can turn ordinary fatigue and lapses into the wrong explanation for change failure.
hero_summary: The fuel-tank metaphor feels intuitive, but it can turn ordinary fatigue and lapses into the wrong explanation for change failure.
layout: default
...
page_heading_title: Is Willpower Really a Tank?
source_count: 46
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: What Happened When Ego Depletion Was Retested?
header:
  og_image: /assets/images/self_improvement_tha_c01280_ego_depletion_debate_45c31f_willpower_tank_myth_d77412-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_ego_depletion_debate_45c31f_willpower_tank_myth_d77412-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_ego_depletion_debate_45c31f_willpower_tank_myth_d77412-Illustration-1-social.jpg
---
...
After a demanding day, people often become more sensitive to [immediate rewards]({{ 'immediate-rewards/' | relative_url }}) and less attentive to long-term goals. The issue may be that attention drifts towards comfort, convenience and relief rather than that self-control has literally run out.
...
This explanation matters because it points towards different solutions. Environmental design, [reminders]({{ 'reminders/' | relative_url }}), routines and reduced friction may help more than simply trying to summon extra determination.
...
* Lack of preparation.
* An [environment]({{ 'environment/' | relative_url }}) full of competing cues.
