...
show_ads: true
description: Feedback works better when it names the task problem instead of turning data into a verdict on character.
hero_summary: Feedback works better when it names the task problem instead of turning data into a verdict on character.
layout: default
permalink: /no-shame/
...
page_heading_title: Why Better Feedback Sounds Less Personal
source_count: 46
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Track the Steering Wheel, Not Just the Score
header:
  og_image: /assets/images/self_improvement_tha_c01280_feedback_loops_fdc3b7_task_focused_feedbac_c64a60-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_feedback_loops_fdc3b7_task_focused_feedbac_c64a60-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_feedback_loops_fdc3b7_task_focused_feedbac_c64a60-Illustration-1-social.jpg
---
...
The first statement describes an [identity]({{ 'identity/' | relative_url }}). The second describes a behaviour. Only one of them suggests a possible intervention.
...
* Timing
* Preparation
* [Environment]({{ 'environment/' | relative_url }})
* Strategy
* Attention
* Sequence
* Resources
