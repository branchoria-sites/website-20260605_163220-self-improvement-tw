...
show_ads: true
description: Activity rings can turn movement into a clear daily target, but the ring should point to the behavior rather than replace the goal.
hero_summary: Activity rings can turn movement into a clear daily target, but the ring should point to the behavior rather than replace the goal.
layout: default
...
page_heading_title: When Activity Rings Help and When They Hurt
source_count: 51
infographic_count: 3
planned_sections:
...
image: /assets/images/self_improvement_tha_c01280_wearables_streaks_315b17_activity_rings_score_44445f-Illustration-1-social.jpg
---
...
* Daily [attention shifts]({{ 'attention-shift/' | relative_url }}) from intention to action.
