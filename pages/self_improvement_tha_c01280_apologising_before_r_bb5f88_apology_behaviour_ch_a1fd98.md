...
show_ads: true
description: Repair becomes credible when the apology names a realistic next action that matches the harm.
hero_summary: Repair becomes credible when the apology names a realistic next action that matches the harm.
layout: default
...
page_heading_title: What Should Change After the Apology?
source_count: 58
infographic_count: 3
planned_sections:
- Why words need a practical repair step
- How to make repair modest and observable
...
image: /assets/images/self_improvement_tha_c01280_apologising_before_r_bb5f88_apology_behaviour_ch_a1fd98-Illustration-1-social.jpg
---
...
* After repeatedly arriving late, the repair is not another apology but arriving early for the next several meetings.
* After interrupting a partner, the repair is creating more space for them to speak and demonstrating that change consistently.
* After missing a commitment at work, the repair may involve a clearer tracking system, earlier updates, or a revised deadline process.

</div>

In each case, the behavioural change is directly related to the original harm. The apology explains the intention to change; the new behaviour provides evidence.
...
### Match the Change to the Harm

The corrective action should address the actual problem rather than demonstrating general goodness.

If someone felt ignored, the repair is improved attention. If someone lost time because of your disorganisation, the repair is improved reliability. If someone was embarrassed publicly, the repair may involve a public correction or acknowledgement.

The closer the action is to the injury, the easier it is for the other person to recognise the connection.

### Make the Change Visible

Observable behaviour creates evidence.

Instead of:

* “I'll be better about communication.”
...
* “I'll send an update every Friday.”
* “I'll check in before making decisions that affect you.”
...
A common failure mode is promising permanent transformation.

Statements such as “I'll never do that again” often create pressure rather than credibility. A smaller commitment is usually more believable:

* “For the next month, I'll keep notes during meetings so I don't interrupt.”
* “I'll set a reminder and confirm plans the day before.”

Behavioural science repeatedly shows that consistent small actions are more reliable than ambitious intentions. The same principle applies to repair: modest changes sustained over time carry more weight than dramatic promises that disappear after a week.

## What Credible Repair Looks Like in Practice

A useful formula is:

**Apology + responsibility + specific future action.**

For example:

> “I'm sorry I dismissed your concern during the meeting. That was unfair. Before our next project discussion, I'll make sure everyone has time to finish their point before I respond.”
...
* Continue the promised behaviour without repeatedly drawing attention to it.
* Check whether the repair action is helping rather than assuming it is.
* Accept that the other person may need more evidence before trust fully returns.
* Avoid using improved behaviour as leverage for immediate absolution.
...
That question shifts attention from image management to implementation. The answer may involve calendars, [reminders]({{ 'reminders/' | relative_url }}), communication routines, decision rules, boundaries, or new habits. Whatever form it takes, the change should be concrete enough that another person could reasonably observe it.

## What Should Change After the Apology?
