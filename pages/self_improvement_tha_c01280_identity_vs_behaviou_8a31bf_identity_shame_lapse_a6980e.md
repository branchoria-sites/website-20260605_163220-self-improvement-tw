...
show_ads: true
description: Missed habits are easier to repair when they are treated as design feedback instead of proof of personal failure.
hero_summary: Missed habits are easier to repair when they are treated as design feedback instead of proof of personal failure.
layout: default
...
page_heading_title: When one missed habit feels like failure
source_count: 45
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Build the proof before claiming the identity
header:
  og_image: /assets/images/self_improvement_tha_c01280_identity_vs_behaviou_8a31bf_identity_shame_lapse_a6980e-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_identity_vs_behaviou_8a31bf_identity_shame_lapse_a6980e-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_identity_vs_behaviou_8a31bf_identity_shame_lapse_a6980e-Illustration-1-social.jpg
---
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to When one missed habit feels like failure. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Encourages quick recovery from lapses instead of self-condemnation.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Promotes gentle behaviour repair after lapses.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Addresses shame, setbacks, and constructive self-response.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps reframe failures as learning opportunities.</p>
        <div class="fr-book-actions">
