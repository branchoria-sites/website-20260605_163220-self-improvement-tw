...
show_ads: true
description: A narrow target can improve effort while quietly encouraging shortcuts, blind spots or neglected priorities.
hero_summary: A narrow target can improve effort while quietly encouraging shortcuts, blind spots or neglected priorities.
layout: default
...
page_heading_title: When Goals Start Rewarding the Wrong Thing
source_count: 41
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Do Public Goals Help or Backfire?
header:
  og_image: /assets/images/self_improvement_tha_c01280_goals_vs_systems_2478d2_goal_side_effects_982f3b-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_goals_vs_systems_2478d2_goal_side_effects_982f3b-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_goals_vs_systems_2478d2_goal_side_effects_982f3b-Illustration-1-social.jpg
---
...
2. Success becomes defined by that target.
3. The target receives disproportionate attention.
4. People discover shortcuts that improve the metric.
5. The shortcut is rewarded.
6. The original purpose is weakened.
...
[Saving]({{ 'saving/' | relative_url }}) money is valuable, but an aggressively framed savings target can encourage behaviours that reduce wellbeing.
