...
show_ads: true
description: 'The if-then structure turns morning coffee into a specific plan: when the cue happens, the first action follows.'
hero_summary: 'The if-then structure turns morning coffee into a specific plan: when the cue happens, the first action follows.'
layout: default
...
page_heading_title: Why If Then Coffee Plans Work
source_count: 54
infographic_count: 3
planned_sections:
...
image: /assets/images/self_improvement_tha_c01280_morning_coffee_cue_d08fd8_coffee_if_then_plan_d283a0-Illustration-1-social.jpg
---
...
* “If I sit down with my coffee, then I will open the project outline.”
* “If I take the first sip, then I will spend ten minutes drafting.”
* “If my coffee reaches the desk, then I will start the first item on today's priority list.”
...
1. **A specific cue**
2. **A specific action**
3. **A low-friction starting point**

</div>

Weak version:

> If I drink my coffee, then I will be productive.

The action is undefined. Productivity still requires negotiation.

Stronger version:

> If I start drinking my coffee at my desk, then I will open the presentation and complete the next slide.

Even stronger version:

> If I take my first sip of coffee, then I will spend five minutes writing bullet points for the presentation.
...
* If the coffee machine starts brewing, then I will close all communication apps.
* If I sit down with my coffee, then I will work on the report for ten minutes.
* If I finish my first sip, then I will write one paragraph before checking email.
...
<span class="citation-chip-wrap"><a class="citation-chip" href="https://thriva.co/hub/behaviour-change/implementation-intentions" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: thriva.co">[implementation intentions]</a><span class="citation-popover" role="note"><span class="citation-popover-source">thriva.co</span><span class="citation-popover-snippet">The Science of &#x27;If-Then&#x27;...20 Nov 2024 — This strategy, developed by psychologist Peter Gollwitzer, transforms vague intentions into spe...</span></span></span> are simple, but small design errors can weaken them.

### Choosing a fuzzy cue
...
Many people connect coffee directly to a demanding objective:

> If I finish my coffee, then I will complete the report.

The report may require several hours and many decisions. The action is too large.

A better approach is:

> If I finish my coffee, then I will write the opening section of the report.
...
One cue should generally lead to one primary action.

For example:

> If I start my coffee, then I might check email, review notes, organise files or begin writing.
...
Even a well-written plan can fail if the required tools are unavailable.

Consider two versions:

* If I take my first sip, then I will start writing.
