...
show_ads: true
description: Pre-commitment lets a calmer earlier self remove predictable negotiations from a more tired later self.
hero_summary: Pre-commitment lets a calmer earlier self remove predictable negotiations from a more tired later self.
layout: default
...
page_heading_title: Let your calmer self choose first
source_count: 39
infographic_count: 3
planned_sections:
- Why future choices feel easier to promise than present ones
- Groceries, first tasks and study partners as pre commitments
...
prev_link:
  ...
  heading_title: Can payday defaults make saving less fragile?
header:
  og_image: /assets/images/self_improvement_tha_c01280_choice_architecture_214f66_precommitment_choice_a385d5-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_choice_architecture_214f66_precommitment_choice_a385d5-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_choice_architecture_214f66_precommitment_choice_a385d5-Illustration-1-social.jpg
---
...
The most useful pre-commitments are often ordinary and low drama. They do not require punishments or heroic discipline. They simply move decisions to a time when judgement is clearer.

### Grocery decisions before hunger arrives
...
* Writing a fixed shopping list and treating additions as exceptions.
* Planning meals before entering a shop.
* Keeping tempting foods out of routine purchasing systems.
...
* Choosing tomorrow's first task before ending today's work.
* Leaving required materials open and ready.
* Scheduling focused work sessions in advance.
* Blocking distracting websites during the intended work period.

</div>

The goal is not to remove freedom entirely. It is to reduce the number of negotiations that occur when attention is weakest.

### Study partners and social commitments
...
Not all pre-commitments are equally strong. They exist on a spectrum.

**Soft pre-commitments** make the desired behaviour easier:

* Preparing gym clothes the night before.
* Scheduling a study session.
* Writing tomorrow's priority list.
* Using [reminders]({{ 'reminders/' | relative_url }}).

**Moderate pre-commitments** create meaningful friction:

* Website [blockers]({{ 'blockers/' | relative_url }}).
* App [limits]({{ 'limits/' | relative_url }}).
...
* Monetary deposits.
* Penalty contracts.
* Public pledges with consequences.
* Systems that remove options entirely.
...
* Extremely restrictive study schedules that collapse after one missed session.
* Severe website blocks that interfere with legitimate work.
* Financial penalties so large that people avoid using the system at all.
* Diet rules that treat one lapse as total failure.
...
1. Identify the predictable weak moment.
2. Decide what behaviour you want to occur instead.
3. Move the decision earlier.
4. Add only enough friction or structure to protect the choice.
5. Leave a reasonable escape route for genuine exceptions.
