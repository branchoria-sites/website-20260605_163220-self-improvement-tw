...
show_ads: true
description: If-then plans can help with predictable moments, but they cannot replace sleep, safety, childcare, treatment, money, or realistic capacity.
hero_summary: If-then plans can help with predictable moments, but they cannot replace sleep, safety, childcare, treatment, money, or realistic capacity.
layout: default
permalink: /limits/
...
page_heading_title: When Is the Obstacle Bigger Than the Plan?
source_count: 33
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How Do You Restart After a Slip?
header:
  og_image: /assets/images/self_improvement_tha_c01280_if_then_plans_58a9d0_limits_of_if_then_pl_b36d32-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_if_then_plans_58a9d0_limits_of_if_then_pl_b36d32-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_if_then_plans_58a9d0_limits_of_if_then_pl_b36d32-Illustration-1-social.jpg
---
...
Many [meaningful goals]({{ 'meaning/' | relative_url }}) depend on systems rather than isolated decisions.

Someone trying to improve health, for example, may benefit from:

* Better sleep opportunities.
* Medical assessment or treatment.
* [Social support]({{ 'social-support/' | relative_url }}).
...
2. **Ask whether the obstacle was a trigger or a constraint.**
...
If-then plans remain one of the most useful tools for predictable temptations and obstacles. They help convert intentions into action and reduce reliance on moment-to-moment [willpower]({{ 'willpower/' | relative_url }}). But their usefulness depends on the nature of the problem.
