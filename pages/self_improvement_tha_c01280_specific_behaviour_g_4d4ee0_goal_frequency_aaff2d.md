...
show_ads: true
description: The best frequency is not always daily; it is the schedule that creates repeatable action and a recovery path after misses.
hero_summary: The best frequency is not always daily; it is the schedule that creates repeatable action and a recovery path after misses.
layout: default
permalink: /frequency/
...
page_heading_title: Should Your Goal Really Be Daily?
source_count: 33
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How to Turn Wishes Into Behaviours
header:
  og_image: /assets/images/self_improvement_tha_c01280_specific_behaviour_g_4d4ee0_goal_frequency_aaff2d-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_specific_behaviour_g_4d4ee0_goal_frequency_aaff2d-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_specific_behaviour_g_4d4ee0_goal_frequency_aaff2d-Illustration-1-social.jpg
---
...
* Family obligations
* Poor sleep
* Unexpected [emergencies]({{ 'emergencies/' | relative_url }})
...
1. **Could I still do this during a difficult week?**

If the answer is no, reduce the frequency.
2. **What happens after I miss one session?**

If the goal has no recovery path, redesign it.
3. **Would I rather succeed at this frequency for a year or a higher frequency for a month?**
