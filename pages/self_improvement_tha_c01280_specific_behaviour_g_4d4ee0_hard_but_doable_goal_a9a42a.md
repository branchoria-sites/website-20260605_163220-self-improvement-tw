...
show_ads: true
description: Specific goals should stretch effort without becoming punishing, especially when the behaviour is new or complex.
hero_summary: Specific goals should stretch effort without becoming punishing, especially when the behaviour is new or complex.
layout: default
...
page_heading_title: When Specific Goals Get Too Hard
source_count: 39
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Should Your Goal Really Be Daily?
header:
  og_image: /assets/images/self_improvement_tha_c01280_specific_behaviour_g_4d4ee0_hard_but_doable_goal_a9a42a-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_specific_behaviour_g_4d4ee0_hard_but_doable_goal_a9a42a-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_specific_behaviour_g_4d4ee0_hard_but_doable_goal_a9a42a-Illustration-1-social.jpg
---
...
1. **Keep the behaviour.**
2. **Reduce the difficulty.**
3. **Re-establish consistency.**
...
* Missing occasionally does not destroy [motivation]({{ 'motivation/' | relative_url }}).
