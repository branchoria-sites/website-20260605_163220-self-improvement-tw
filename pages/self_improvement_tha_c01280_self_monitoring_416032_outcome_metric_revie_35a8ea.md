...
show_ads: true
description: Outcomes can help test whether a habit is working, but checking them too often turns noisy data into judgement.
hero_summary: Outcomes can help test whether a habit is working, but checking them too often turns noisy data into judgement.
layout: default
...
page_heading_title: When should outcomes be reviewed?
source_count: 49
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Track intensely, then stop
header:
  og_image: /assets/images/self_improvement_tha_c01280_self_monitoring_416032_outcome_metric_revie_35a8ea-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_self_monitoring_416032_outcome_metric_revie_35a8ea-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_self_monitoring_416032_outcome_metric_revie_35a8ea-Illustration-1-social.jpg
---
...
Separating behaviour tracking from outcome review protects [motivation]({{ 'motivation/' | relative_url }}).
...
The behavioural measures receive daily attention because they guide today's decisions. The outcome measures receive [weekly review]({{ 'weekly-review/' | relative_url }}) because they answer whether the behaviour package is producing results.
...
* **Noise becomes [meaning]({{ 'meaning/' | relative_url }}).** Random variation is interpreted as evidence.
...
* **Self-worth becomes attached to numbers.** The metric shifts from information to [identity]({{ 'identity/' | relative_url }}).
