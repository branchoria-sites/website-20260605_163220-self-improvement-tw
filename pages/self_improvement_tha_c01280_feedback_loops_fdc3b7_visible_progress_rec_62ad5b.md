...
show_ads: true
description: Written or visible records can reveal patterns that feelings and memory usually blur or exaggerate.
hero_summary: Written or visible records can reveal patterns that feelings and memory usually blur or exaggerate.
layout: default
...
page_heading_title: Why Memory Is a Bad Habit Tracker
source_count: 31
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: The Weekly Review That Fixes the Plan
header:
  og_image: /assets/images/self_improvement_tha_c01280_feedback_loops_fdc3b7_visible_progress_rec_62ad5b-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_feedback_loops_fdc3b7_visible_progress_rec_62ad5b-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_feedback_loops_fdc3b7_visible_progress_rec_62ad5b-Illustration-1-social.jpg
---
...
Researchers studying self-regulation have found that monitoring progress helps people compare their current state with a goal and make corrections when needed. The benefit comes from reducing uncertainty about what is actually happening. <span class="citation-chip-wrap"><a class="citation-chip" href="https://pubmed.ncbi.nlm.nih.gov/26479070/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: pubmed.ncbi.nlm.nih.gov">[PubMed]</a><span class="citation-popover" role="note"><span class="citation-popover-source">pubmed.ncbi.nlm.nih.gov</span><span class="citation-popover-title">Pub Med Does monitoring goal progress promote goal attainment?</span><span class="citation-popover-snippet">B Harkin · 2016 · Cited by 750 — The findings suggest that monitoring goal progress is an effective self-regulation strategy, and...</span></span></span>
...
The strongest evidence for progress monitoring suggests that the act of recording itself adds value. In a large meta-analysis, interventions produced larger improvements when monitored information was physically recorded rather than simply observed or remembered. <span class="citation-chip-wrap"><a class="citation-chip" href="https://eprints.whiterose.ac.uk/id/eprint/87431/1/bul" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: eprints.whiterose.ac.uk">[White Rose Research Online]</a><span class="citation-popover" role="note"><span class="citation-popover-source">eprints.whiterose.ac.uk</span><span class="citation-popover-snippet">Moderation tests revealed that progress monitoring had larger effects on goal attainment when the outcomes were reported or made public...</span></span></span>
...
Most progress records remain private, and for many people that is enough. However, evidence suggests that progress monitoring can become more effective when information is reported to others or made public in some form. Studies reviewed in the goal-monitoring literature found stronger effects when progress was reported or publicly visible compared with monitoring that remained entirely private. <span class="citation-chip-wrap"><a class="citation-chip" href="https://eprints.whiterose.ac.uk/id/eprint/87431/1/bul" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: eprints.whiterose.ac.uk">[White Rose Research Online]</a><span class="citation-popover" role="note"><span class="citation-popover-source">eprints.whiterose.ac.uk</span><span class="citation-popover-snippet">Moderation tests revealed that progress monitoring had larger effects on goal attainment when the outcomes were reported or made public...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Why Memory Is a Bad Habit Tracker. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Strong emphasis on visible records and habit tracking.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Encourages simple tracking and observation of behavior.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Demonstrates the value of external records over memory.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains why observed patterns matter more than memory.</p>
        <div class="fr-book-actions">
