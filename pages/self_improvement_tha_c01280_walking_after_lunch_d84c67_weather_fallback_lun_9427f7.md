...
show_ads: true
description: Rain, wind, heat, and cold are predictable habit threats, so a useful lunch-walk plan needs an indoor or covered fallback.
hero_summary: Rain, wind, heat, and cold are predictable habit threats, so a useful lunch-walk plan needs an indoor or covered fallback.
layout: default
...
page_heading_title: What happens when the weather breaks the habit?
source_count: 44
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Are three short walks better than one?
header:
  og_image: /assets/images/self_improvement_tha_c01280_walking_after_lunch_d84c67_weather_fallback_lun_9427f7-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_walking_after_lunch_d84c67_weather_fallback_lun_9427f7-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_walking_after_lunch_d84c67_weather_fallback_lun_9427f7-Illustration-1-social.jpg
---
...
Many people find these routes psychologically easier than fully indoor alternatives because they still provide a change of [environment]({{ 'environment/' | relative_url }}).

### Shopping centres and public indoor spaces

Public health guidance frequently recommends climate-controlled indoor walking locations when outdoor conditions are poor. The CDC specifically suggests mall walking as an alternative when weather makes outdoor walking difficult. The American Heart Association also lists mall walking among practical indoor activity options.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.cdc.gov/nccdphp/dnpao/features/getting-more-active-minutes/index.html" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: cdc.gov">[CDC]</a><span class="citation-popover" role="note"><span class="citation-popover-source">cdc.gov</span><span class="citation-popover-title">Tips for Getting More Active Minutes</span><span class="citation-popover-snippet">Keep walking shoes... If you normally walk outside but the weather is bad, head to the local mall for a climate-controlled walk.Read more...</span></span></span>
...
The goal is not to create a harder workout. It is to preserve the [identity]({{ 'identity/' | relative_url }}) of being someone who moves after lunch.
...
Heat deserves more caution. Lunch commonly falls near the warmest part of the day. Public-health guidance recommends reducing outdoor activity during periods of high heat, staying hydrated, seeking cooler environments, and considering air-conditioned locations when temperatures become excessive.<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.bccdc.ca/health-info/prevention-public-health/preparing-for-heat-events" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: bccdc.ca">[BC Centre for Disease Control]</a><span class="citation-popover" role="note"><span class="citation-popover-source">bccdc.ca</span><span class="citation-popover-snippet">BC Centre for Disease ControlPreparing for Heat EventsIdentify a cooler space in your home and prepare it so you can stay there at night...</span></span></span> [3CDC 3CDC]
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to What happens when the weather breaks the habit?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Shows how to maintain habits despite disruptions.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for creating fallback versions of a behavior.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains preserving routines when conditions change.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=The+Joy+of+Movement+Kelly+McGonigal&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open The Joy of Movement on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://books.google.com/books/content?id=5bSPDwAAQBAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=1&amp;edge=curl&amp;source=gbs_api" alt="Cover for The Joy of Movement" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=The+Joy+of+Movement+Kelly+McGonigal&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="The Joy of Movement">The Joy of Movement</a>
        </h4>
        <p class="fr-book-author">By Kelly McGonigal</p>

        <p class="fr-book-desc">Encourages flexible movement under varied conditions.</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=The+Joy+of+Movement+Kelly+McGonigal&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
