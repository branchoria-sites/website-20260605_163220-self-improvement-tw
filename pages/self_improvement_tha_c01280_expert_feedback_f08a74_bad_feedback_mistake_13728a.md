...
show_ads: true
description: Feedback can backfire when it becomes vague, personal, humiliating, or detached from the next useful action.
hero_summary: Feedback can backfire when it becomes vague, personal, humiliating, or detached from the next useful action.
layout: default
...
page_heading_title: When Feedback Helps Less Than It Hurts
source_count: 56
infographic_count: 3
planned_sections:
...
image: /assets/images/self_improvement_tha_c01280_expert_feedback_f08a74_bad_feedback_mistake_13728a-Illustration-1-social.jpg
---
...
Public embarrassment can create compliance in the short term, but it often damages [motivation]({{ 'motivation/' | relative_url }}), trust and willingness to seek future feedback.
