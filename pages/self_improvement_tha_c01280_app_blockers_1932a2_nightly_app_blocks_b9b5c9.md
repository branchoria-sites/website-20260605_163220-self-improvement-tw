...
show_ads: true
description: A bedtime block works best when it starts before sleep time, leaving room for a real wind-down instead of a last-minute fight.
hero_summary: A bedtime block works best when it starts before sleep time, leaving room for a real wind-down instead of a last-minute fight.
layout: default
...
page_heading_title: Stop the bedtime scroll before it starts
source_count: 54
infographic_count: 3
planned_sections:
...
image: /assets/images/self_improvement_tha_c01280_app_blockers_1932a2_nightly_app_blocks_b9b5c9-Illustration-1-social.jpg
---
...
One reason some blocking systems fail is that they feel absolute. People worry about family [emergencies]({{ 'emergencies/' | relative_url }}), urgent work messages or the need to make a call. That anxiety can become an excuse to disable the entire system.
