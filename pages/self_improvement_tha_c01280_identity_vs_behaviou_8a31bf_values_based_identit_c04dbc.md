...
show_ads: true
description: Identity language works better when it connects action to chosen values, competence, and relationships rather than pressure.
hero_summary: Identity language works better when it connects action to chosen values, competence, and relationships rather than pressure.
layout: default
...
page_heading_title: Change works better when it feels chosen
source_count: 43
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why groups can make change feel normal
header:
  og_image: /assets/images/self_improvement_tha_c01280_identity_vs_behaviou_8a31bf_values_based_identit_c04dbc-Illustration-1-social.jpg
  preview_image: /assets/images/self_improvement_tha_c01280_identity_vs_behaviou_8a31bf_values_based_identit_c04dbc-Illustration-1.webp
image: /assets/images/self_improvement_tha_c01280_identity_vs_behaviou_8a31bf_values_based_identit_c04dbc-Illustration-1-social.jpg
---
...
2. Initial motivation is high because of urgency or [social pressure]({{ 'social-pressure/' | relative_url }}).

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

3. Effort becomes exhausting because the goal does not feel personally meaningful.
4. A setback occurs.
5. Motivation collapses because the underlying reason was never fully internalised.
...
* "I value generosity" becomes more believable after repeated acts of [support]({{ 'support/' | relative_url }}) and service.
...
A person who joins a running club, volunteer organisation or supportive professional community gains more than accountability. They gain a social [environment]({{ 'environment/' | relative_url }}) where desired behaviours become normal. The behaviour begins to align with both personal values and group expectations.
